...
class RequestProvider extends RequestProviderType {
  ...
  @override
  Future<ResponseDto<T>> deleteAsync<T>(String uri, Queue<RequestParameter> params) async {
    var request = await _createRequest();
    var response = await request.delete(_setUri(uri), data: _setBody(params));
    try {
      return BaseJsonConverter.shared.decode(response: response, responseType: ResponseDto<T>());
    } catch (e) {
      rethrow;
    }
  }
  ...
  Future<ResponseDto<T>> getAsync<T>(String uri, Queue<RequestParameter> params) async {
    var request = await _createRequest();
    try {
      var response = await request.get(_setUri(uri), queryParameters: _setQueryParameters(params));
      return BaseJsonConverter.shared.decode(response: response, responseType: ResponseDto<T>());
    } catch (e) {
      rethrow;
    }
  ...
  @override
  Future<ResponseDto<T>> postAsync<T>(String uri, Queue<RequestParameter> params) async {
    var request = await _createRequest();
    try {
  ...
  @override
  Future<ResponseDto<T>> putAsync<T>(String uri, Queue<RequestParameter> params) async {
    var request = await _createRequest();
